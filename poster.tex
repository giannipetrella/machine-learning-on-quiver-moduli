...
\title{Machine learning features on quiver moduli}
...
\begin{column}{\colwidth}
  ...
  is~$\tuple{d} \colonequals (\dim(V_i))_{i \in Q_0}$.
  ...
  \begin{block}{Moduli spaces of stable representations}
    ...
    is a variety whose points correspond to equivalence classes of representations.

    Under apppropriate conditions, it is a smooth projective variety.
